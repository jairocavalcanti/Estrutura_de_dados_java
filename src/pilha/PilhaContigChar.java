...
public class PilhaContigChar {
	...
	public boolean palavra_inversa(String palavra, String palavra_2) {
      
		if(palavra.length() != palavra_2.length()){
		  return false;
	    }
		...
		String invertida = "";
        while (!pilha.eVazia()) {
            invertida += pilha.desempilhar().getChave();
        }

        return invertida.equals(palavra_2);
    }
