...
public class ListaSimples {
	...
	public boolean saoIdenticas(ListaSimples L1, ListaSimples L2) {
		...
		if (L1.getQuantNos() != L2.getQuantNos()) {
			...
			// Se ambas as listas foram completamente percorridas sem encontrar diferenças,
			// elas são idênticas
	...
	public int procurarOuInserir(int valor) {
		if (this.eVazia()) { // Se a lista está vazia, insere o valor no final da lista
			...
			return 1; // Retorna a quantidade de vezes que o valor aparece na lista (que neste caso é
						// 1, pois acabou de ser inserido)
		} else {
			int quantidade = 0;
			No atual = this.prim;
